...
<body>
    ...
    <div class="container">
        ...
        <a class="btn btn-primary" href="nuevo_producto.php">Crear nuevo producto</a>
        <a class="btn btn-primary" href="../categorias/index.php">Ir a categorias</a>
        <br><br>
        <table class="table table-striped table-hover">
            ...
            <?php
                while ($fila = $resultado -> fetch_assoc()) {
                    ...
                    ?>
                    <td>  
                        <img width="150" height="200" src="../imagenes/<?php echo $fila["imagen"] ?>">
                    </td>
                    <?php
